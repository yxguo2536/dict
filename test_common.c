...
#define BUFFER word
    ...
    for (;;) {
        ...
        case 's':
            ...
            rmcrlf(BUFFER);
            t1 = tvgetf();
            res = tst_search_prefix(root, BUFFER, sgl, &sidx, LMAX);
            t2 = tvgetf();
            if (res) {
        ...
        case 'd':
            ...
            res = tst_ins_del(&root, BUFFER, DEL, MODE);
            t2 = tvgetf();
            if (res)
